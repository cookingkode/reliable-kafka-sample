...
public class ConsumerTask extends Thread {
    ...
    public ConsumerTask(List<String> topics, EventService service, ConcurrentMap<String, Object> controlMap ) {
        ...
        setupReliableConsumptionSetting(props);
    ...
    private void setupReliableConsumptionSetting(Properties props) {
    ...
    public void run() {
        while (!closed.get()) {
            ...
            // this call commits *all* records *across* all TopicPartitions returned by poll() above
            consumer.commitSync();
        }
    }
